<?php
include_once('login_check.php');l
?>
<html >
<head>
  ...
  <link rel="shortcut icon" href="assets/images/mbr-532x355.jpg" type="image/x-icon">
            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="https://mobirise.com">
                         <img src="assets/images/mbr-532x355.jpg" alt="Mobirise" title="" style="height: 3.8rem;">
                    </a>
                </span>
        ...
        <div class="row justify-content-center">
            <div class="title col-12 col-lg-8">
                <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">
                    Logout</h2>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-5"><br><?php echo "Bye Bye ".$_SESSION['name']; ?><br></h3>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <html class="gr__localhost"><head><meta http-equiv="Content-Type" content="text/html; charset=EUC-KR"></head><body data-gr-c-s-loaded="true"><form class="mbr-form" action="sign_out.php" method="post"><input type="hidden" name="email" data-form-email="true" value="pb57c1bZNn2kAOSgOnhw1xL+giCfaOCKygqOosb8g3tbFizMO0jO7ywDrV7RsGof5zJ6WL9uT0Mqs7mZdPHJCO2bxePGO/LDP2Cw+cQw+A9L00EFsHdDGJybo6uAO/od">
                        <span class="input-group-btn"><button href="sign_out.php" type="submit" class="btn btn-primary btn-form display-4">logout</button></span>
                    </form>
        </div>
    </div>
</section>
